...
La verdad que este primer módulo me sirvió bastante para cambiar la cabeza sobre cómo encarar los laburos técnicos. El punto fuerte fue entender que el contenido va por un lado y el diseño por otro. Olvidate de renegar con el Word para que no se te desacomode todo el texto; meterse con herramientas como LaTeX o HTML te obliga a armar primero el esqueleto de la información y recién después fijarte cómo queda a la vista.

Por otro lado, el tema de usar notebooks es muy práctico. Poder meter los cálculos, el análisis y la explicación teórica, todo en una misma pantalla, te agiliza un montón el proceso. A eso sumale haber visto un poco de GitHub y cómo armar un buen README; te da la pauta de cómo mantener un proyecto ordenado para que no sea un caos de archivos sueltos y se pueda replicar fácil.

Pensando a futuro, creo que agarrarle la mano a esto va a ser fundamental para lo que me queda de ingeniería. Son herramientas que me van a facilitar bastante los informes pesados de la facu, y además es exactamente lo que te sirve el día de mañana en el ámbito profesional: trabajar de forma clara, organizada y dejando un registro fácil de seguir.
...
\includepdf[pages=-, pagecommand={\thispagestyle{plain}}]{Simple_Hipster_CV.pdf}
